    ...
    return (
        <SafeAreaView>
            ...
            <StyledView className='flex flex-col items-center justify-center h-screen w-[100vw] px-8'>
                ...
                <StyledPressable className='bg-indigo-700 text-white py-2 w-full rounded-full my-0.5' onPress={() => router.push(routes.registration.part2 as Href)}>
                ...
                <StyledView className='flex flex-row items-center justify-center mt-4'>
                    ...
                    <StyledPressable onPress={() => router.push(routes.registration.part2 as Href)}>
